...
func (p *Ping) httping(ip *net.IPAddr) (int, time.Duration) {
	...
	{
		requ, err := http.NewRequest(http.MethodHead, HttpingURL, nil)
		if err != nil {
			return 0, 0
		}
	...
	for i := 0; i < PingTimes; i++ {
		...
		requ.Header.Set("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36")
		if i == PingTimes-1 {
